...
%>
		...
		<div class="head-bottom">			
			<ul class="megamenu skyblue">
				...
				<li class="active grid"><a href="<%=cp%>/myPage/order/orderList.do">주문 내역</a></li> 
	            <li class="active grid"><a href="<%=cp%>/myPage/order/cancleList.do">취소/반품 내역</a></li>            
				<li class="active grid"><a href="<%=cp%>/myPage/order/bankList.do">입금/환불 내역</a></li>
