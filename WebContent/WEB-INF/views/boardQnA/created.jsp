...
<script type="text/javascript">
    function check() {
    	...
    	var mode="${mode}";
    	if(mode=="created")
    		f.action="<%=cp%>/boardQnA/created_ok.do";
    	else if(mode=="update")
    		f.action="<%=cp%>/boardQnA/update_ok.do";
    	else if(mode=="reply"){
    		f.action="<%=cp%>/boardQnA/reply_ok.do";
    	}
					  ...
					  <table style="width: 800px; margin: 0px auto; border-spacing: 0px;">
					     <tr height="45"> 
					      <td align="center" >
		        		    ...
		        		    <a href="javascript:location.href='<%=cp%>/boardQnA/list.do';">
