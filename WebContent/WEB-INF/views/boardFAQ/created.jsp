...
<script type="text/javascript">
    function check() {
    	...
    	var mode="${mode}";
    	if(mode=="created")
    		f.action="<%=cp%>/boardFAQ/created_ok.do";
    	else if(mode=="update")
    		f.action="<%=cp%>/boardFAQ/update_ok.do";
					  ...
					  <table style="width: 800px; margin: 0px auto; border-spacing: 0px;">
					     <tr height="45"> 
					      <td align="center" >
		        		    ...
		        		    <a href="javascript:location.href='<%=cp%>/boardFAQ/list.do';"><img src="<%=cp%>/res/images/btn_cancel.jpg" border="0"></a>
