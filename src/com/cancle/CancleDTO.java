...
public class CancleDTO {
	...
	public String getReturnPayCreated() {
		return returnPayCreated;
	}
	public void setReturnPayCreated(String returnPayCreated) {
		this.returnPayCreated = returnPayCreated;
	}
	...
	public void setPayCreated(String payCreated) {
		this.payCreated = payCreated;
	}
	public String getPayRoot() {
		return payRoot;
	}
	public void setPayRoot(String payRoot) {
